...
class Detalle__especialidad extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['id_especialidad', 'fecha_inicio', 'fecha_fin', 'hora_inicio', 'hora_fin', 'numero_reservas', 'precio', 'descuento', 'bookeable', 'activo', 'descripcion'];
     ...
     * @var array
     */
    protected $casts = ['bookeable' => 'boolean', 'activo' => 'boolean'];
