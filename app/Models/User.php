...
class User extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['username', 'email', 'password', 'role_id', 'seen', 'valid', 'confirmed', 'confirmation_code', 'remember_token'];
     ...
     * @var array
     */
    protected $casts = ['seen' => 'boolean', 'valid' => 'boolean', 'confirmed' => 'boolean'];
