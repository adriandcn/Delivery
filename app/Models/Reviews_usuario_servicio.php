...
class Reviews_usuario_servicio extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['id_usuario_servicio', 'nombre_reviewer', 'email_reviewer', 'ip_reviewer', 'text_review', 'estado_review', 'calificacion', 'peso', 'id_user', 'id_tipo_review', 'tip_text', 'review_verificado', 'confirmation_rev_code', 'seen', 'agrupamiento_id'];
     ...
     * @var array
     */
    protected $casts = ['estado_review' => 'boolean', 'seen' => 'boolean'];
