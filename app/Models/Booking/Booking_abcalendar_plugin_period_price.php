...
class Booking_abcalendar_plugin_period_price extends Model  {
     ...
     * @var string
     */
    protected $table = 'booking_abcalendar_plugin_period_price';
     ...
     * @var array
     */
    protected $fillable = ['period_id', 'adults', 'children', 'price'];
