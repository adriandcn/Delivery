...
class Ubicacion_geografica extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['estado', 'nombre', 'idUbicacionGeograficaPadre', 'id_region', 'descripcion_esp', 'descripcion_eng', 'descripcion_adicional_esp', 'descripcion_adicional_eng', 'capital_provincia'];
