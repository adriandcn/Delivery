...
class Image extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['filename', 'original_name', 'password', 'user_id', 'id_auxiliar', 'id_catalogo_fotografia', 'id_usuario_servicio', 'estado_fotografia', 'descripcion_fotografia', 'es_principal', 'profile_pic'];
     ...
     * @var array
     */
    protected $casts = ['estado_fotografia' => 'boolean', 'es_principal' => 'boolean', 'profile_pic' => 'boolean'];
