...
class Catalogo_evento extends Model  {
     ...
     * @var string
     */
    protected $table = 'catalogo_eventos';
     ...
     * @var array
     */
    protected $fillable = ['id_catalogo_eventos', 'estado_catalogo_eventos', 'nombre_catalogo_eventos', 'fecha_creacion', 'fecha_fin', 'nombre_catalogo_eventos_eng'];
     ...
     * @var array
     */
    protected $casts = ['estado_catalogo_eventos' => 'boolean'];
