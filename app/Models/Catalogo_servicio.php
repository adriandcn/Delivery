...
class Catalogo_servicio extends Model  {
     ...
     * @var array
     */
    protected $fillable = ['id_catalogo_servicios', 'estado_catalogo_servicios', 'nombre_servicio', 'fecha_creacion_servicio', 'fecha_fin_servicio', 'nombre_servicio_eng'];
     ...
     * @var array
     */
    protected $casts = ['estado_catalogo_servicios' => 'boolean'];
